...
and California\cite{3-CA-ADC-3406}.
...
(Jan.\ 1, Jan.\ 2, ect.) %@NCM: wait, below we say weekly- harmonize here?
...
%@NCM: I usually think of a ``run'' as a single simulation. Not sure it matters here- do we refer to runs
% later?
...
% @NCM I think we should standardize on either ABS PQL or pe95. I vote for the former as more consistent
...
%@NCM: Give df in the above stats?
