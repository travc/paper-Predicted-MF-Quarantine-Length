...
normal temperatures for forward projection.%@TCC|@NCM: should really have a citation for this!
...
It may overestimate required quarantine length through cold weather %@TCC|@NCM CITE??
and may underestimate length when growth conditions are very favorable, 
which somewhat paradoxically leads to quicker expected extirpation under SIT. %@TCC|@NCM CITE??
...
%However, the choice of 95\% extirpation as the threshold is somewhat arbitrary and does not 
...
%plausible parameter values (high reproduction rate, low mortality, ect.)
...
TCC: Wrote the temperature parsing, degree day, and other analysis code.
