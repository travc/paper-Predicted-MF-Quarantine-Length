...
Excluding SFO, the mean normal is a good predictor of DD PQL with values normally below 20 days
...
The standard deviation of MED-FOES based PQL normals shown in figure \ref{fig:pe95_variation_summary}
...
Results for FAT show a sharp increase in uncertainty starting in September, which fits with the 
