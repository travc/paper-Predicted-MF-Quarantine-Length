...
repeated detections are followed by 
quarantines to eliminate the invading population. However, it is notoriously difficult to set quarantine
duration because the non-detection of the pest does not necessarily mean the pest
is extirpated. Most programs determine quarantine lengths 
...
explicitly simulate population demographics and extirpation. Here, the predicted 
quarantine length for 11 sites in the continental United States were evaluated. Results indicate that 
strong seasonality in quarantine length, with longer predictions in the second half of the year compared with the first; this pattern was more extreme in the degree day predictions compared 
with the ABS. Geographically, quarantine lengths increased with latitude, though again this feature was 
less pronounced under the ABS. Variation in quarantine lengths for particular times and places was 
significantly higher for degree day versus ABS, and generally peaked in the middle of the year for the
former and second half of the year for the latter. Analysis of 34 \emph{C. capitata} quarantines
from 1975 to 2017 in California shows that 
all but two were declared in the second half of the year, when degree day quarantine lengths are
longest and have the highest uncertainty.
For this set of hypothetical quarantines, 
the ABS produced significantly shorter quarantines
than degree day calculations. 
Overall, ABS quarantine lengths were more consistent than degree day predictions, avoided unrealistically long values seen in the northermost site studied (San Fransisco), 
...
cryptic establishment of Medfly in California\cite{carey201730}, 
...
(Jan.\ 1, Jan.\ 2, ect.) %@TCC: wait, below we say weekly- harmonize here?
...
%@TCC: I usually think of a ``run'' as a single simulation. Not sure it matters here- do we refer to runs
% later?
Run data are translated into PQL by the number of days from the start date required for
95\% of the simulations in a run to be eradicated, also referred to as pe95.
% @TCC I think we should standardize on either ABS PQL or pe95. I vote for the former as more consistent
% with DD PQL, and also more commonly used. Can eliminate pe95?
