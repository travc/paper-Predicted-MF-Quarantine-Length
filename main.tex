...
>>>>>>> 7e771b8871ecede7be6fd0ff0a0665a5acfcaf86
...
%The outlier nature of SFO with respect to DD PQL is obvious in figure \ref{fig:DD_variation_summary};
%While the $\sigma$ for other sites is below 20 days for the majority of outbreak start dates
%and rise above only for outbreaks starting in the late summer or autumn, 
%SFO's DD PQL $\sigma$ is around 100 days for winter outbreaks 
%and decreases down to about 40 days for late summer outbreaks.
